...
public class Tester3WithBTree {

	private MainClass mainClass;
	private BTreeDatabase btreeDatabase;
	private Database theDatabase;
	
	public Tester3WithBTree() {
	...
	public long run() {
		...
		String[] theQueries = new String[] {
			...
			// insert first 10 doros until Noach into the first table
				...
				"CREATE INDEX GPA_Index on YCStudent10 (GPA)",
			...
			"CREATE INDEX CurrentStudent_Index on YCStudent11 (CurrentStudent)",
			"CREATE INDEX FirstName_Index on YCStudent11 (FirstName)",
				...
				//"CREATE INDEX Credits_Index on YCStudent11 (Credits)",
